...
public class GimbalDAO {
    ...
    public static void setOptInShown(Context context) {
        Log.e("MS-GimbalDAO", "setOptInShown ");
    ...
    public static List<GimbalEvent> getEvents(Context context) {
        ...
        try {
            ...
            Log.e("MS-GimbalDAO", "getEvents() jsonString = "+jsonString);
            if (jsonString != null) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                   ...
                   /* PLACE_ENTER, PLACE_ENTER_DELAY, PLACE_EXIT, COMMUNICATION_PRESENTED, COMMUNICATION_ENTER, COMMUNICATION_EXIT,
                    ...
                    if (TYPEStr.equals("PLACE_ENTER")||TYPEStr.equals("PLACE_ENTER_DELAY")||TYPEStr.equals("PLACE_EXIT")
                            ){
                        event.setType(TYPE.valueOf(TYPEStr));
    ...
    public static void setEvents(Context context, List<GimbalEvent> events) {
        try {
            ...
            for (GimbalEvent event : events) {
                ...
                Log.e("event", "type = "+event.getType().name() + ": title = "+event.getTitle()+": date = "+event.getDate().getTime());
